...
(function() {
  ...
  PhaserArcanoid = (function() {
    ...
    PhaserArcanoid.prototype.preload = function() {
      this.game.load.spritesheet('ground', 'assets/images/ground.png', 640, 24);
      this.game.load.image('fail', 'assets/images/fail.png');
    ...
    PhaserArcanoid.prototype.create = function() {
      ...
      this.ground.animations.add('fail', [0, 1, 0, 1, 0], 10, false, true);
    ...
    PhaserArcanoid.prototype.ballFalled = function(ball, ground) {
      ...
      this.ground.animations.play('fail');
      if (this.lives === 0) {
